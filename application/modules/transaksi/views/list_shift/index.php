<div class="col-xs-12" style="margin-top: 10px;">
	<div class="col-xs-2 no-padding" style="padding-right: 5px;">
		<div class="col-xs-12 input-group date datetimepicker" name="tanggal" id="Tanggal">
	...
	<div class="col-xs-4 no-padding" style="padding-left: 5px;">
		<button type="button" class="btn btn-primary" onclick="ls.getLists()"><i class="fa fa-search"></i> Tampilkan</button>
	</div>
</div>
<div class="col-xs-12">
