	...
	<div class="row">
		<div class="col-lg-12">
			<div class="col-md-12 no-padding" style="padding: 5px;">
				<span style="font-weight: bold;">MENU : <span class="nama_menu"></span></span>
			</div>
		</div>
		...
		<div class="col-lg-12">
			<div class="col-md-8 no-padding" style="height: 40px; padding: 5px;">
				<div class="col-md-12 text-center jumlah button" style="height: 100%; display: flex; justify-content: center; align-items: center; background-color: #ffffff; border-color: #dedede;">
					<span></span>
				</div>
			</div>
