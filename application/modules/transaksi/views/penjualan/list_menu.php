<?php if ( !empty($data) ): ?>
	<?php foreach ($data as $k_data => $v_data): ?>
		...
		<?php } else { ?>
			<div class="col-sm-4 no-padding menu cursor-p" data-id="<?php echo $v_data['id']; ?>" onclick="jual.getMenuGroup(this)">
				<div class="col-sm-12 border">
					<div class="col-sm-12 no-padding menu_group">
						<div class="col-sm-12 no-padding nama_menu"><?php echo $v_data['nama']; ?></div>
					</div>
				</div>
			</div>
		<?php } ?>
