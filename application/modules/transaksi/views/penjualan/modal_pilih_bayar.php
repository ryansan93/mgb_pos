	...
	<div class="row">
		<div class="col-lg-12" style="padding-top: 10px;">
			<div class="col-md-6 no-padding" style="height: 100px; padding-right: 1%;">
				<div class="col-md-12 text-center cursor-p btn-simpan button" style="height: 100%; display: flex; justify-content: center; align-items: center;">
					<span><b>SIMPAN</b></span>
				</div>
			</div>
			<div class="col-md-6 no-padding" style="height: 100px; padding-left: 1%;">
				<div class="col-md-12 text-center cursor-p btn-lanjut button" style="height: 100%; display: flex; justify-content: center; align-items: center;">
					<span><b>LANJUT PEMBAYARAN</b></span>
				</div>
			</div>
